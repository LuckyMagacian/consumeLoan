...
public interface MerchantDao{
	 ...
	 */
	public void deleteMerchantByClass(@Param(value="merchant")Merchant merchant);
	/**根据唯一索引从数据库中删除数据
	...
	/**选中数据库中符合条件的数据|数据本身
	 * @param Merchant 选中的条件|数据本身 * @return 符合条件的数据列表 */
	public List<Merchant> selectMerchantByClass(@Param(value="merchant")Merchant merchant);
	/**根据唯一索引选中数据库中的数据
	 * @param merchantId 索引:商户编号
	 * @return 符合条件的数据对象 */
