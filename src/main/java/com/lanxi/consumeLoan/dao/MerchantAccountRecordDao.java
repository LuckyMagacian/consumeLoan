...
public interface MerchantAccountRecordDao{
	 ...
	 */
	public void deleteMerchantAccountRecordByClass(MerchantAccountRecord merchantAccountRecord);
	/**根据唯一索引从数据库中删除数据
	...
	public List<MerchantAccountRecord> selectMerchantAccountRecordByClass(MerchantAccountRecord merchantAccountRecord);
	/**根据唯一索引选中数据库中的数据
	 * @param nanoTime 索引:记录时间戳-纳秒
	 * @return 符合条件的数据对象 */
