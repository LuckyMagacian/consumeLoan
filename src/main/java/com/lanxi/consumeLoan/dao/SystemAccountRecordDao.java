...
public interface SystemAccountRecordDao{
	 ...
	 */
	public void deleteSystemAccountRecordByClass(@Param(value="systemAccountRecord")SystemAccountRecord systemAccountRecord);
	/**根据唯一索引从数据库中删除数据
	...
	/**选中数据库中符合条件的数据|数据本身
	 * @param SystemAccountRecord 选中的条件|数据本身 * @return 符合条件的数据列表 */
	public List<SystemAccountRecord> selectSystemAccountRecordByClass(@Param(value="systemAccountRecord")SystemAccountRecord systemAccountRecord);
	/**根据唯一索引选中数据库中的数据
	 * @param nanoTime 索引:记录时间戳-纳秒
	 * @return 符合条件的数据对象 */
